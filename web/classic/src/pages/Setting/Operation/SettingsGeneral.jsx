        ...
        >
          <Form.Section text={t('通用设置')}>
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Input
                  field={'general_setting.ai_use_link'}
                  label={t('AI创作地址')}
                  initValue={''}
                  placeholder={t('例如 https://example.com/ai-create')}
                  onChange={handleFieldChange('general_setting.ai_use_link')}
                  showClear
                />
              </Col>
